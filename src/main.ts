...
export class Accessibility implements IAccessibility {
  ...
  constructor(options = {} as IAccessibilityOptions) {
    ...
    if (this.options.icon.useEmojis) {
      ...
      this._common.injectIconsFont(
        this.options.icon.fontFaceSrc,
        (hasError: boolean) => {
          this.build();
  ...
  initFontSize() {
    ...
    if (!this._htmlInitFS) {
      let htmlInitFS = this._common.getFormattedDim(
        getComputedStyle(this._html).fontSize
      );
      let bodyInitFS = this._common.getFormattedDim(
        getComputedStyle(this._body).fontSize
      );
      this._html.style.fontSize =
        ((htmlInitFS.size as number) / 16) * 100 + "%";
      this._htmlOrgFontSize = this._html.style.fontSize;
      this._body.style.fontSize =
        (bodyInitFS.size as number) / (htmlInitFS.size as number) + "em";
    }
  }
  ...
  addDefaultOptions(options: IAccessibilityOptions) {
    ...
    if (!this.options.icon.closeIconElem)
      this.options.icon.closeIconElem = {
        type: "#text",
        text: `${
          !this.options.icon.useEmojis ? this.options.icon.closeIcon : "X"
        }`,
      };
    if (!this.options.icon.resetIconElem)
      this.options.icon.resetIconElem = {
        type: "#text",
        text: `${
          !this.options.icon.useEmojis ? this.options.icon.resetIcon : "♲"
        }`,
      };
    ...
    if (injectFull) {
      css = `
            ...
            ._access-icon {
                ...
                transform: ${
                  !this.options.icon.useEmojis ? "scale(1)" : "skewX(14deg)"
                };
            ...
            ._access-menu.close {
                ...
                right: calc(-1 * var(--_access-menu-width, ${
                  Accessibility.MENU_WIDTH
                }));
            }
            ...
            ._access-menu ul li button:before {
                content: ' ';
                font-family: var(--_access-menu-button-font-family-before, ${
                  this._fixedDefaultFont
                });
                ...
                font-size: ${
                  !this.options.icon.useEmojis ? "24px" : "20px"
                } !important;
                width: 30px;
                height: 30px;
                display: inline-block;
            ...
            ._access-menu ul li button[data-access-action="increaseText"]:before {
                content: var(--_access-menu-item-icon-increase-text, ${
            ...
            ._access-menu ul li button[data-access-action="decreaseText"]:before {
                content: var(--_access-menu-item-icon-decrease-text, ${
            ...
            ._access-menu ul li button[data-access-action="increaseTextSpacing"]:before {
                content: var(--_access-menu-item-icon-increase-text-spacing, ${
            ...
            ._access-menu ul li button[data-access-action="decreaseTextSpacing"]:before {
                content: var(--_access-menu-item-icon-decrease-text-spacing, ${
            ...
            ._access-menu ul li button[data-access-action="invertColors"]:before {
                content: var(--_access-menu-item-icon-invert-colors, ${
            ...
            ._access-menu ul li button[data-access-action="grayHues"]:before {
                content: var(--_access-menu-item-icon-gray-hues, ${
                  !this.options.icon.useEmojis ? '"format_color_reset"' : '"🌫️"'
                });
            ...
            ._access-menu ul li button[data-access-action="underlineLinks"]:before {
                content: var(--_access-menu-item-icon-underline-links, ${
            ...
            ._access-menu ul li button[data-access-action="readingGuide"]:before {
                content: var(--_access-menu-item-icon-reading-guide, ${
                  !this.options.icon.useEmojis ? '"border_horizontal"' : '"↔️"'
                });
            ...
            ._access-menu ul li button[data-access-action="textToSpeech"]:before {
                content: var(--_access-menu-item-icon-text-to-speech, ${
                  !this.options.icon.useEmojis ? '"record_voice_over"' : '"⏺️"'
                });
            ...
            ._access-menu ul li button[data-access-action="speechToText"]:before {
                content: var(--_access-menu-item-icon-speech-to-text, ${
            ...
            ._access-menu ul li button[data-access-action="disableAnimations"]:before {
                content: var(--_access-menu-item-icon-disable-animations, ${
                  !this.options.icon.useEmojis ? '"animation"' : '"🏃‍♂️"'
                });
            ...
            ._access-menu ul li button[data-access-action="iframeModals"]:before {
                content: var(--_access-menu-item-icon-iframe-modals, ${
                  !this.options.icon.useEmojis ? '"policy"' : '"⚖️"'
                });
            ...
            ._access-menu ul li button[data-access-action="customFunctions"]:before {
                content: var(--_access-menu-item-icon-custom-functions, ${
                  !this.options.icon.useEmojis ? '"psychology_alt"' : '"❓"'
                });
            ...
            ._access-menu ul li button[data-access-action="increaseLineHeight"]:before {
                content: var(--_access-menu-item-icon-increase-line-height, ${
                  !this.options.icon.useEmojis ? '"unfold_more"' : '"🔼"'
                });
            ...
            ._access-menu ul li button[data-access-action="decreaseLineHeight"]:before {
                content: var(--_access-menu-item-icon-decrease-line-height, ${
                  !this.options.icon.useEmojis ? '"unfold_less"' : '"🔽"'
                });
              ...
              children: [
                {
                  ...
                  attrs: {
                    ...
                    title: this.parseKeys(
                      this.options.hotkeys.keys.disableAnimations
                    ),
                    tabIndex: "-1",
                  },
                  children: [
    ...
    if (this.options.iframeModals) {
      this.options.iframeModals.forEach((im, i) => {
        ...
        if (this.options.modules.textToSpeech)
          json.children[1].children.splice(
            json.children[1].children.length - 2,
            0,
            btn
          );
  ...
  addListeners() {
    ...
    [...Array.from(step1), ...Array.from(step2), ...Array.from(step3)].forEach(
      (el) =>
        el.addEventListener(
          "click",
          (e: Event) => {
            ...
            this.invoke(
              (
                evt.target as HTMLElement
              ).parentElement.parentElement.getAttribute("data-access-action"),
              evt.target as HTMLElement
            );
          },
          false
  ...
  sortModuleTypes() {
    this.options.modulesOrder.sort(
      (a: IAccessibilityModuleOrder, b: IAccessibilityModuleOrder) => {
  ...
  disableUnsupportedModulesAndSort() {
    ...
    this.options.modulesOrder.forEach((item) => {
      ...
      let moduleLi = document.querySelector(
        'button[data-access-action="' + module + '"]'
      );
      if (moduleLi) {
  ...
  resetTextSize() {
    this.resetIfDefined(
      this._stateValues.body.fontSize,
      this._body.style,
      "fontSize"
    );
    ...
    for (let i = 0; i < all.length; i++) {
      (all[i] as HTMLElement).style.fontSize = all[i].getAttribute(
        "data-init-font-size"
      );
  ...
  resetLineHeight() {
    ...
    for (let i = 0; i < all.length; i++) {
      (all[i] as HTMLElement).style.lineHeight = all[i].getAttribute(
  ...
  resetTextSpace() {
    ...
    for (let i = 0; i < all.length; i++) {
      (all[i] as HTMLElement).style.wordSpacing = all[i].getAttribute(
        "data-init-word-spacing"
      );
      all[i].removeAttribute("data-init-word-spacing");
    }
    for (let i = 0; i < all2.length; i++) {
      (all[i] as HTMLElement).style.letterSpacing = all[i].getAttribute(
    ...
    if (this.options.textPixelMode) {
      ...
      for (let i = 0; i < all.length; i++) {
        ...
        if (this._stateValues.textToSpeech)
          this.textToSpeech(
            `Text Size ${isIncrease ? "Increased" : "Decreased"}`
          );
      }
      ...
      if (fp.indexOf("%")) {
        ...
        this._common.warn(
          "Accessibility.textEmlMode, html element is not set in %."
        );
      }
    } else {
      let fSize = this._common.getFormattedDim(
        getComputedStyle(this._body).fontSize
      );
      ...
      if (fSize && fSize.suffix && !isNaN((fSize.size as number) * 1)) {
        this._body.style.fontSize =
          (fSize.size as number) * 1 + factor + fSize.suffix;
      }
    }
  }
  ...
  alterLineHeight(isIncrease: boolean) {
    ...
    for (let i = 0; i < all.length; i++) {
      ...
      if (this.options.textPixelMode) {
        ...
        if (this._stateValues.textToSpeech)
          this.textToSpeech(
            `Line Height ${isIncrease ? "Increased" : "Decreased"}`
          );
      } else if (this.options.textEmlMode) {
  ...
  alterTextSpace(isIncrease: boolean) {
    ...
    if (this.options.textPixelMode) {
      ...
      if (this._stateValues.textToSpeech)
        this.textToSpeech(
          `Text Spacing ${isIncrease ? "Increased" : "Decreased"}`
        );
    } else {
      // wordSpacing
      let fSpacing = this._common.getFormattedDim(
        getComputedStyle(this._body).wordSpacing
      ) as any;
    ...
    if ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) {
      ...
      this._recognition.onresult = (event: any) => {
        ...
        if (finalTranscript && this._speechToTextTarget) {
          this._speechToTextTarget.parentElement.classList.remove(
            "_access-listening"
          );
          if (
            ...
            (this._speechToTextTarget as HTMLInputElement).value =
              finalTranscript;
          } else if (
            this._speechToTextTarget.getAttribute("contenteditable") !== null
          ) {
  ...
  listen() {
    if (
      typeof this._recognition === "object" &&
  ...
  read(e: Event) {
    ...
    let allContent = Array.prototype.slice.call(
      document.querySelectorAll("._access-menu *")
    );
    ...
    let act = Object.entries(this.options.hotkeys.keys).find(function (val) {
      ...
      for (var i = 0; i < val[1].length; i++) {
        if (Number.isInteger(val[1][i])) {
          ...
          if (
            (e as any)[val[1][i]] === undefined ||
            (e as any)[val[1][i]] === false
          ) {
            pass = false;
          }
        }
  ...
  build() {
    ...
    this._body =
      document.body || (document.getElementsByTagName("body")[0] as any);
    this._html =
      document.documentElement || document.getElementsByTagName("html")[0];
    if (this.options.textEmlMode) this.initFontSize();
    this.injectCss(
      !this.options.suppressCssInjection && !this.options.suppressDomInjection
    );
